				...
				$(document).off('click', '#lpa_create').on('click', '#lpa_create', function() { 
					...
					//$.mobile.changePage("five.html", { transition: "slide", changeHash: false, reverse: false });
                        ...
                        success: function (result) {
							console.log(result);
							alert('Data submitted succesfully 123 55555555');
							//$('#basic').popup('open'); 
...
//var div_val='<div class="ui-grid-c vgb" id="checkbox'+c+'"><div class="row" style="background-color: #ebebeb; height: 70px;    margin-left: 5px;margin-right: 7px;"><div class="col-xs-8 padz "><div class="box">Crushing - Like tighteneing with a rope</div></div><div class="col-xs-4 padz"><div class="box"><fieldset data-role="controlgroup" data-type="horizontal" data-mini="true" class="ui-controlgroup ui-controlgroup-horizontal ui-corner-all ui-mini"><div class="ui-controlgroup-controls "><div class="ui-radio ui-mini"><label class="flo">Yes:</label><input type="radio" id="result_yes'+c+'" name="result_yes'+c+'"  value="yes" ></div><div class="ui-radio ui-mini"><label class="flo">No:</label><input type="radio" id="result_yes'+c+'" name="result_yes'+c+'" value="no" class="marl" checked><br id="result_no_br'+c+'"><br id="result_no_br'+c+'"></div></div></fieldset></div></div></div></div>'
					c++;
